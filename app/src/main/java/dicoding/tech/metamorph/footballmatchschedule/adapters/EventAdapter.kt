...
class EventAdapter(private val event: List<EventItem>, private val listener: (EventItem) -> Unit): RecyclerView.Adapter<EventAdapter.ViewHolder>(){
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItem(schedule: EventItem, listener: (EventItem) -> Unit){
